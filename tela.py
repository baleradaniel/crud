...
class CRUDApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(self.root, text='User ID(for update/dalete):').grid(row=5, column=0)
        ...
        # botões 
        tk.Button(self.root, text='Criar', command=self.create_user).grid(row=6, column=0, columnspan=1)
        tk.Button(self.root, text='Listar', command=self.create_user).grid(row=6, column=1, columnspan=1)
        tk.Button(self.root, text='Atualizar', command=self.create_user).grid(row=7, column=0, columnspan=1)
